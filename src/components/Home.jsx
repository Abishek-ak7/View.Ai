    ...
    <div className="Home bg-ipad-mini min-h-screen overflow-hidden 2xl:container bg-gradient-to-b from-black to-[#20016c]" id="Home">
      <div className="flex justify-between items-center">
        ...
        <div className='flex justify-between gap-x-8'>
          <h1 className='font-extrabold mx-4 text-white hover:text-cyan-400 p-2'>Our USP</h1>
          <h1 className='font-extrabold mx-4 text-white hover:text-cyan-400 p-2'>About Us</h1>
          <h1 className='font-extrabold mx-4 text-white hover:text-cyan-400 p-2'>Solution</h1>
          <h1 className='font-extrabold mx-4 text-white hover:text-cyan-400 p-2'>Connect Us</h1>
        ...
        <div className='hidden sm:hidden md:block lg:block'>
          ...
          <div className="flex  justify-evenly pr-2 py-0.5 mr-10 mt-3">
            ...
            <p className="text-white mr-1 text-xl cursor-pointer mb-0.5 font-bold">Login</p>
          </div>
          </Link>
        </div>
      ...
      <div className='mt-44 md:mt-0' id="second">
        ...
        <p className='text-center mt-10 text-lg text-white md:mb-10'>Our custom formal e-commerce SaaS platform stands out by integrating cutting-edge AI for personalized recommendations,<br />
